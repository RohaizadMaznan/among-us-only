        ...
        <form className="max-w-screen grid sm:grid-cols-2 gap-4 mx-auto">
          <div className="sm:col-span-2 space-y-2">
            ...
            <div className="flex justify-between items-starts">
              <button className="flex justify-center items-center bg-gray-100 hover:bg-gray-300 active:bg-indigo-700 focus-visible:ring ring-indigo-300 text-gray-800 text-sm font-semibold text-center rounded outline-none transition duration-100 px-5 py-2 space-x-2">
